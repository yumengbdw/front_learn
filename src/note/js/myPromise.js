...
class yuPromise {
  ...
  最后一步根据promise+  3.1规范 then回调的两个参数onFulfilled 和 onRejected必须异步执行，要放入会放入事件队列等待下一轮 tick

所以上述代码中then = (successCallback, failCallback)  successCallback和failCallback 调用必须
